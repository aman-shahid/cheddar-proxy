...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if(DEFINED ENV{CARGOKIT_TEMP_DIR})
        file(TO_CMAKE_PATH "$ENV{CARGOKIT_TEMP_DIR}" CARGOKIT_TEMP_ROOT)
        if(NOT IS_ABSOLUTE "${CARGOKIT_TEMP_ROOT}")
            set(CARGOKIT_TEMP_ROOT "${CMAKE_SOURCE_DIR}/${CARGOKIT_TEMP_ROOT}")
        endif()
        set(CARGOKIT_TEMP_DIR "${CARGOKIT_TEMP_ROOT}/cargokit_build/${lib_name}")
    else()
